/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: fe2a98445539126660559731bb1724cb)
// Runtime types generated with workerd@1.20260625.1 2026-06-26 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	GEMINI_API_KEY: string;
	DATABASE_URL: string;
	WORKER_SELF_REFERENCE: Fetcher /* autocontent */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GEMINI_API_KEY" | "DATABASE_URL">> {}
}
