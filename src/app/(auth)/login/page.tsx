    ...
    <div className="h-full flex">
      ...
      >
        ...
        <div className="relative z-10 max-w-md px-8 text-center">
          ...
          >
            <Link href="/">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-primary to-purple-600 flex items-center justify-center shadow-2xl shadow-primary/40 mx-auto mb-8 hover:scale-105 transition-transform cursor-pointer">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        ...
        >
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link href="/" className="text-primary font-medium hover:underline">Créer un compte gratuitement</Link>
          </p>
        </motion.div>
      </div>
    </div>
